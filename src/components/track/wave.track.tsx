...
const WaveTrack = (props: IProps) => {
  ...
  const { currentTrack, setCurrentTrack, currentTime, setCurrentTime, nextTrack } =
  ...
  const optionsMemo = useMemo((): Omit<WaveSurferOptions, 'container'> => {
    ...
    if (typeof window !== 'undefined') {
      ...
      gradient.addColorStop((canvas.height * 0.7) / canvas.height, 'rgba(255, 105, 180, 0.4)'); // Hot pink middle
      gradient.addColorStop((canvas.height * 0.7 + 1) / canvas.height, 'rgba(255, 255, 255, 0.9)'); // White line
      gradient.addColorStop((canvas.height * 0.7 + 2) / canvas.height, 'rgba(255, 255, 255, 0.9)'); // White line
      gradient.addColorStop((canvas.height * 0.7 + 3) / canvas.height, 'rgba(255, 182, 193, 0.6)'); // Pink bottom
    ...
    <div className="wave-track-container" style={{ marginTop: 20 }}>
      <div
        ...
        style={{
          ...
          padding: 20,
          minHeight: 350,
          background: 'linear-gradient(135deg, rgb(162, 139, 175)  0%, #FF69B4 100%)',
        ...
        >
          ...
          >
            ...
            >
              ...
              <div className="comments-on-wave" style={{ position: 'relative' }}>
                {comments.map((item) => {
                  return (
                    <Tooltip
                      key={item._id}
